...
INSERT INTO profiles (user_id,
                      ...
                      sport_attitude_id,
                      pet_attitude_id)
VALUES (1, 'Male', 180, 'Обожаю исследовать новое.', 1, 1, 1, 2, 1, 1, 1),
       (2, 'Female', 165, 'Энтузиаст природы и авантюрист.', 3, 4, 2, 1, 2, 2, 2),
       (3, 'Male', 175, 'Страстно увлечен технологиями и спортом.', 5, 1, 3, 3, 3, 3, 3),
       (4, 'Male', 175, 'Страстно увлечен автомобилями.', 5, 1, 3, 3, 3, 3, 3),
       (5, 'Female', 170, 'Люблю природу.', 5, 2, 3, 3, 3, 3, 3),
       (6, 'Female', 165, 'Обожаю музыку.', 5, 2, 3, 3, 3, 3, 3),
       (7, 'Female', 168, 'Звезда кантри-музыки.', 5, 1, 3, 3, 3, 3, 3),
       (8, 'Female', 172, 'Профессиональный фокусник.', 5, 1, 3, 3, 3, 3, 3),
       (9, 'Female', 160, 'Звезда кино <3.', 5, 2, 3, 3, 3, 3, 3),
       (10, 'Female', 167, 'Защищу вас в суде.', 5, 2, 3, 3, 3, 3, 3);
